...
class Seg14x4(HT16K33):
    ...
    def number(self, number, decimal=0):
        ...
        if self.debug:
            print("(1) number = {0}, places = {1}, decimal = {2}, s = '{3}'".format(
                number, places, decimal, s))
        ...
        if self.debug:
            print("(2) places = {0}, dot = '{1}', decimal = {2}, s = '{3}'".format(
                places, dot, decimal, s))
        ...
        if self.debug:
            print("(3) places = {0}, s = '{1}', decimal = {2}, txt = '{3}'".format(
                places, s, decimal, txt))
            print()
