...
for rom in roms:
  ...
  # set what will displayed, per line, this display update
  oled.text('Hello, Brand 1!', 0, 0)
  oled.text('Hello, Brand 2!', 0, 8)
  oled.text('Hello, Brand 3!', 0, 16)
  # update screen with above info
  oled.show()
